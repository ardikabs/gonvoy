...
* Full Go experience for building Envoy extension.
...
* [Stats](https://www.envoyproxy.io/docs/envoy/latest/intro/arch_overview/observability/statistics#arch-overview-statistics) support, allow users to generate their custom metrics, it shipped with labels support also.
