...
// IsFilterPhaseEnabled provides a mock function with given fields: _a0
func (_m *MockContext) IsFilterPhaseEnabled(_a0 HttpFilterPhase) bool {
	ret := _m.Called(_a0)
...
// MockContext_IsFilterPhaseEnabled_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsFilterPhaseEnabled'
type MockContext_IsFilterPhaseEnabled_Call struct {
	*mock.Call
}

// IsFilterPhaseEnabled is a helper method to define mock.On call
//   - _a0 HttpFilterPhase
func (_e *MockContext_Expecter) IsFilterPhaseEnabled(_a0 interface{}) *MockContext_IsFilterPhaseEnabled_Call {
	return &MockContext_IsFilterPhaseEnabled_Call{Call: _e.mock.On("IsFilterPhaseEnabled", _a0)}
}

func (_c *MockContext_IsFilterPhaseEnabled_Call) Run(run func(_a0 HttpFilterPhase)) *MockContext_IsFilterPhaseEnabled_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockContext_IsFilterPhaseEnabled_Call) Return(_a0 bool) *MockContext_IsFilterPhaseEnabled_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockContext_IsFilterPhaseEnabled_Call) RunAndReturn(run func(HttpFilterPhase) bool) *MockContext_IsFilterPhaseEnabled_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockContext) JSON(code int, b []byte, headers map[string][]string, opts ...ReplyOption) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(int, []byte, map[string][]string, ...ReplyOption) error); ok {
...
//   - opts ...ReplyOption
func (_e *MockContext_Expecter) JSON(code interface{}, b interface{}, headers interface{}, opts ...interface{}) *MockContext_JSON_Call {
	return &MockContext_JSON_Call{Call: _e.mock.On("JSON",
		append([]interface{}{code, b, headers}, opts...)...)}
}

func (_c *MockContext_JSON_Call) Run(run func(code int, b []byte, headers map[string][]string, opts ...ReplyOption)) *MockContext_JSON_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockContext_JSON_Call) RunAndReturn(run func(int, []byte, map[string][]string, ...ReplyOption) error) *MockContext_JSON_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockContext) ServeFilter(ctrl HttpFilterPhaseController) api.StatusType {
	...
	if rf, ok := ret.Get(0).(func(HttpFilterPhaseController) api.StatusType); ok {
		r0 = rf(ctrl)
	} else {
...
func (_m *MockContext) String(code int, s string, headers map[string][]string, opts ...ReplyOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(int, string, map[string][]string, ...ReplyOption) error); ok {
...
//   - headers map[string][]string
//   - opts ...ReplyOption
func (_e *MockContext_Expecter) String(code interface{}, s interface{}, headers interface{}, opts ...interface{}) *MockContext_String_Call {
	return &MockContext_String_Call{Call: _e.mock.On("String",
		append([]interface{}{code, s, headers}, opts...)...)}
}

func (_c *MockContext_String_Call) Run(run func(code int, s string, headers map[string][]string, opts ...ReplyOption)) *MockContext_String_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]ReplyOption, len(args)-3)
		for i, a := range args[3:] {
			if a != nil {
...
func (_c *MockContext_String_Call) RunAndReturn(run func(int, string, map[string][]string, ...ReplyOption) error) *MockContext_String_Call {
	_c.Call.Return(run)
	return _c
}
