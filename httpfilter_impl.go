...
// httpFilter is an HTTP Filter implementation for Envoy.
...
func (f *httpFilter) DecodeTrailers(api.RequestTrailerMap) api.StatusType {
	return api.Continue
}

func (f *httpFilter) EncodeTrailers(api.ResponseTrailerMap) api.StatusType {
	return api.Continue
}
...
func (f *httpFilter) decodeHeaders(header api.RequestHeaderMap) HttpFilterDecoderFunc {
...
func (f *httpFilter) decodeData(buffer api.BufferInstance, endStream bool) HttpFilterDecoderFunc {
	return func(c Context, p HttpFilterDecodeProcessor) (HttpFilterAction, error) {
...
func (f *httpFilter) encodeHeaders(header api.ResponseHeaderMap) HttpFilterEncoderFunc {
...
func (f *httpFilter) encodeData(buffer api.BufferInstance, endStream bool) HttpFilterEncoderFunc {
	return func(c Context, p HttpFilterEncodeProcessor) (HttpFilterAction, error) {
