...
func (_m *RequestHeaderMap) GetAllHeaders() map[string][]string {
	ret := _m.Called()
...
// RequestHeaderMap_GetAllHeaders_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAllHeaders'
type RequestHeaderMap_GetAllHeaders_Call struct {
	*mock.Call
}

// GetAllHeaders is a helper method to define mock.On call
func (_e *RequestHeaderMap_Expecter) GetAllHeaders() *RequestHeaderMap_GetAllHeaders_Call {
	return &RequestHeaderMap_GetAllHeaders_Call{Call: _e.mock.On("GetAllHeaders")}
}

func (_c *RequestHeaderMap_GetAllHeaders_Call) Run(run func()) *RequestHeaderMap_GetAllHeaders_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *RequestHeaderMap_GetAllHeaders_Call) Return(_a0 map[string][]string) *RequestHeaderMap_GetAllHeaders_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RequestHeaderMap_GetAllHeaders_Call) RunAndReturn(run func() map[string][]string) *RequestHeaderMap_GetAllHeaders_Call {
	_c.Call.Return(run)
	return _c
}
