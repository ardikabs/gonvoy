...
func (_m *MockHttpFilterHandler) OnRequestBody(c Context) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for OnRequestBody")
	}
...
func (_m *MockHttpFilterHandler) OnRequestHeader(c Context) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for OnRequestHeader")
	}
...
func (_m *MockHttpFilterHandler) OnResponseBody(c Context) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for OnResponseBody")
	}
...
func (_m *MockHttpFilterHandler) OnResponseHeader(c Context) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for OnResponseHeader")
	}
