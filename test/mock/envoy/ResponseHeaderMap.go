...
// ResponseHeaderMap_ByteSize_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ByteSize'
type ResponseHeaderMap_ByteSize_Call struct {
	*mock.Call
}

// ByteSize is a helper method to define mock.On call
func (_e *ResponseHeaderMap_Expecter) ByteSize() *ResponseHeaderMap_ByteSize_Call {
	return &ResponseHeaderMap_ByteSize_Call{Call: _e.mock.On("ByteSize")}
}

func (_c *ResponseHeaderMap_ByteSize_Call) Run(run func()) *ResponseHeaderMap_ByteSize_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ResponseHeaderMap_ByteSize_Call) Return(_a0 uint64) *ResponseHeaderMap_ByteSize_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ResponseHeaderMap_ByteSize_Call) RunAndReturn(run func() uint64) *ResponseHeaderMap_ByteSize_Call {
	_c.Call.Return(run)
	return _c
}
