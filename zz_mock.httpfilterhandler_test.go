...
func (_m *MockHttpFilterHandler) OnRequestBody(c Context, body []byte) error {
	ret := _m.Called(c, body)

	var r0 error
	if rf, ok := ret.Get(0).(func(Context, []byte) error); ok {
		r0 = rf(c, body)
	} else {
		r0 = ret.Error(0)
	}
...
//   - c Context
//   - body []byte
func (_e *MockHttpFilterHandler_Expecter) OnRequestBody(c interface{}, body interface{}) *MockHttpFilterHandler_OnRequestBody_Call {
	return &MockHttpFilterHandler_OnRequestBody_Call{Call: _e.mock.On("OnRequestBody", c, body)}
}

func (_c *MockHttpFilterHandler_OnRequestBody_Call) Run(run func(c Context, body []byte)) *MockHttpFilterHandler_OnRequestBody_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(Context), args[1].([]byte))
	})
	return _c
}
...
func (_c *MockHttpFilterHandler_OnRequestBody_Call) RunAndReturn(run func(Context, []byte) error) *MockHttpFilterHandler_OnRequestBody_Call {
	_c.Call.Return(run)
	return _c
}

// OnRequestHeader provides a mock function with given fields: c, header
func (_m *MockHttpFilterHandler) OnRequestHeader(c Context, header http.Header) error {
	ret := _m.Called(c, header)

	var r0 error
	if rf, ok := ret.Get(0).(func(Context, http.Header) error); ok {
		r0 = rf(c, header)
	} else {
		r0 = ret.Error(0)
	}
...
//   - c Context
//   - header http.Header
func (_e *MockHttpFilterHandler_Expecter) OnRequestHeader(c interface{}, header interface{}) *MockHttpFilterHandler_OnRequestHeader_Call {
	return &MockHttpFilterHandler_OnRequestHeader_Call{Call: _e.mock.On("OnRequestHeader", c, header)}
}

func (_c *MockHttpFilterHandler_OnRequestHeader_Call) Run(run func(c Context, header http.Header)) *MockHttpFilterHandler_OnRequestHeader_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(Context), args[1].(http.Header))
	})
	return _c
}
...
func (_c *MockHttpFilterHandler_OnRequestHeader_Call) RunAndReturn(run func(Context, http.Header) error) *MockHttpFilterHandler_OnRequestHeader_Call {
	_c.Call.Return(run)
	return _c
}

// OnResponseBody provides a mock function with given fields: c, body
func (_m *MockHttpFilterHandler) OnResponseBody(c Context, body []byte) error {
	ret := _m.Called(c, body)
...
//   - c Context
//   - body []byte
func (_e *MockHttpFilterHandler_Expecter) OnResponseBody(c interface{}, body interface{}) *MockHttpFilterHandler_OnResponseBody_Call {
	return &MockHttpFilterHandler_OnResponseBody_Call{Call: _e.mock.On("OnResponseBody", c, body)}
}

func (_c *MockHttpFilterHandler_OnResponseBody_Call) Run(run func(c Context, body []byte)) *MockHttpFilterHandler_OnResponseBody_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(Context), args[1].([]byte))
	})
	return _c
...
func (_c *MockHttpFilterHandler_OnResponseBody_Call) RunAndReturn(run func(Context, []byte) error) *MockHttpFilterHandler_OnResponseBody_Call {
	_c.Call.Return(run)
	return _c
}

// OnResponseHeader provides a mock function with given fields: c, header
func (_m *MockHttpFilterHandler) OnResponseHeader(c Context, header http.Header) error {
	ret := _m.Called(c, header)
...
//   - c Context
//   - header http.Header
func (_e *MockHttpFilterHandler_Expecter) OnResponseHeader(c interface{}, header interface{}) *MockHttpFilterHandler_OnResponseHeader_Call {
	return &MockHttpFilterHandler_OnResponseHeader_Call{Call: _e.mock.On("OnResponseHeader", c, header)}
}

func (_c *MockHttpFilterHandler_OnResponseHeader_Call) Run(run func(c Context, header http.Header)) *MockHttpFilterHandler_OnResponseHeader_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(Context), args[1].(http.Header))
	})
	return _c
...
func (_c *MockHttpFilterHandler_OnResponseHeader_Call) RunAndReturn(run func(Context, http.Header) error) *MockHttpFilterHandler_OnResponseHeader_Call {
	_c.Call.Return(run)
	return _c
}
