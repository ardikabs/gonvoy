...
func (f *Filter) OnBegin(c gonvoy.RuntimeContext, ins *gonvoy.Instance) error {
	...
	ins.AddHandler(&handler.HandlerOne{})
	ins.AddHandler(&handler.HandlerTwo{})
	ins.AddHandler(&handler.HandlerThree{RequestHeaders: cfg.RequestHeaders})
	return nil
}
